  ...
  const features = [
    {
      icon: IconPhone,
      title: 'Fast Booking',
      description: 'Our simple and intuitive booking process gets you from search to seat without stress.'
    },
    {
      icon: IconShield,
      title: 'Safety First',
      description: 'We operate with strict safety standards, modern aircraft, and highly trained crew on every flight.'
    },
    {
      icon: IconMoney,
      title: 'Affordable Prices',
      description: 'Enjoy competitive fares without compromising comfort, service, or reliability.'
    },
    {
      icon: IconClock,
      title: 'On Time Flight',
      description: 'We value your time and work hard to ensure departures and arrivals stay on schedule.'
    }
  ]
